...
namespace SXEdu2XHKD.Domain.BLL
{
	...
	{
		private readonly SXEdu2XHKD.Domain.Concrete.DAL.Class dal=new SXEdu2XHKD.Domain.Concrete.DAL.Class();
		...
		public bool Delete(string ClassName,int SchoolId,int GradeId)
		{
			...
			return dal.Delete(ClassName,SchoolId,GradeId);
		}
		...
		public SXEdu2XHKD.Domain.Entities.Class GetModel(string ClassName,int SchoolId,int GradeId)
		{
			...
			return dal.GetModel(ClassName,SchoolId,GradeId);
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<SXEdu2XHKD.Domain.Entities.Class> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<SXEdu2XHKD.Domain.Entities.Class> DataTableToList(DataTable dt)
		{
			List<SXEdu2XHKD.Domain.Entities.Class> modelList = new List<SXEdu2XHKD.Domain.Entities.Class>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				SXEdu2XHKD.Domain.Entities.Class model;
